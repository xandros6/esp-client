...
import org.esp.upload.DatasetManager;
...
public class GeoserverPublisher extends CustomField<IndicatorSurface>
    ...
    Logger logger = LoggerFactory.getLogger(GeoserverPublisher.class);
    ...
    @Inject
    public GeoserverPublisher(GeoserverRest gsr, Dao dao) {
    ...
    public void uploadFinished(FinishedEvent event) {
        ...
        if (mt.is(MediaType.TIFF)) {
            try {
                SpatialDataType sdt = dao.find(SpatialDataType.class, 1l);
            ...
            try {
                ...
                SpatialDataType sdt = dao.find(SpatialDataType.class, 2l);
                surface.setSpatialDataType(sdt);
